          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                {loading ? (
                  <tr>
                    <td colSpan={3} className="p-8 text-center text-gray-500">Loading database...</td>
                  </tr>
                  ...
                  filteredWatches.map((watch) => (
                    <tr key={watch.id} className="hover:bg-gray-50 transition-colors">
                      <td className="p-4">
                        <div className="text-sm font-bold text-gray-900">{watch.watch_query}</div>
                      </td>
                      ...
                      <td className="p-4 text-right">
                        <Link 
                          href={`/watch/${watch.id}`} 
                          className="inline-block bg-indigo-600 text-white py-2 px-4 rounded-lg font-bold text-xs hover:bg-indigo-700 transition-colors shadow-sm"
                        >
                          View Details &rarr;
                        </Link>
                      </td>
