                    ...
                    <tr key={watch.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="p-4 text-sm hidden sm:table-cell">
                        {watch.requires_battery ? (
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">{watch['Model Number']}</span>
                        ) : (
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">Mechanical / Solar</span>
                        )}
                      </td>
